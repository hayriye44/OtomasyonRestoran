            ...
            while(dr.Read())
            {
                foreach(Control item in this.Controls)
                {
                    if(item is Button)
                    {
                        ...
                        {
                            item.BackgroundImage=(System.Drawing.Image)(Properties.Resources.masaa);
                        }
                        else if(item.Name=="btnMasa"+dr["ID"].ToString()&& dr["DURUM"].ToString()=="2")
                        {
                            ...
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.kırmızımasa);    
                        }
                        else if(item.Name=="btnMasa"+dr["ID"].ToString()&& dr["DURUM"].ToString()=="3")
                        { item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.mavimasa); }
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "4")
                        { item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.mormasa); }
                    }
                }
            }
        }
